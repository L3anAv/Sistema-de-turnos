...
//--- Metodo toString (Sobre-escritura) de Sistema de Turnos.
	...
	public String toString() {
		...
		toStringNombreSistema.append("--- Sistema de Turnos para Votación --- ")
		.append("\n").append("--- ")
		.append(nombreDelSistema).append("\n")
		.append("\n")
		.append("Votantes registrados en el sistema: ")
		.append("\n")
		.append("\n");
		...
		while(itmap.hasNext()){
		    ...
		    if(votante.tieneTurnoAsignado()) {
		    	toStringNombreSistema.append("Nombre: ").append(votante.getNombre()).append(" | ")
		    	.append("DNI: ")
		    	.append(dniVotante)
		    	.append(" | Mi turno: ").append("Mesa N°").append(turnoVotante.getX())
		    	.append(" a las ").append(turnoVotante.getY()).append(" Horas.")
		    	.append("\n");
		    } else {
		    	toStringNombreSistema.append("Nombre: ").append(votante.getNombre()).append(" | ")
		    	.append("DNI: ")
		    	.append(dniVotante).append(" | ")
		    	.append("Todavia no tengo turno asignado por el sistema.")
		    	.append("\n");
		    }
